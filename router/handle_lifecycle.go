...
func (rt *Handle) Setup(
	...
	rt.routerTransformInputHistogram = stats.Default.NewTaggedStat("router_transform_input_histogram", stats.HistogramType, statTags)
	rt.routerTransformOutputHistogram = stats.Default.NewTaggedStat("router_transform_output_histogram", stats.HistogramType, statTags)
	rt.routerTransformDestJobsHistogram = stats.Default.NewTaggedStat("router_transform_dest_jobs_histogram", stats.HistogramType, statTags)
