...
func New(ctx context.Context, clearDb *bool, gwDb, rtDb, brtDb, errDbForRead, errDBForWrite, esDB, arcDB *jobsdb.Handle,
	...
	rsourcesService rsources.JobService, transformerFeaturesService transformerFeaturesService.TransformerFeaturesService, destDebugger destinationdebugger.DestinationDebugger, transDebugger transformationdebugger.TransformationDebugger,
	enrichers []enricher.PipelineEnricher,
	opts ...Opts,
) *LifecycleManager {
